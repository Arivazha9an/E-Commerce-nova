...
class Loadreturninvoice extends StatefulWidget {
  final Map<String, dynamic> data;
  const Loadreturninvoice({super.key, required this.data});

  @override
  State<Loadreturninvoice> createState() => _InvoiceState();
}

class _InvoiceState extends State<Loadreturninvoice> {
