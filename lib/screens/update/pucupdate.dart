...
class UpdateFormPUCT extends StatefulWidget {
  final String docId;
  final Map<String, dynamic> data;

  const UpdateFormPUCT({super.key, required this.docId, required this.data});

  @override
  State<UpdateFormPUCT> createState() => _UpdateFormState();
}
