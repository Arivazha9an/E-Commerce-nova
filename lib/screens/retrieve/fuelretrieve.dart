...
import 'package:e_commerce/screens/update/refuelupdate.dart';
...
class Fuelretrieve2 extends StatefulWidget {
  const Fuelretrieve2({super.key});

  @override
  State<Fuelretrieve2> createState() => _Fuelretrieve2State();
}

class _Fuelretrieve2State extends State<Fuelretrieve2> {
