...
import 'package:e_commerce/screens/update/insuranceupdate.dart';
...
class Insuranceretrive2 extends StatefulWidget {
  const Insuranceretrive2({super.key});

  @override
  State<Insuranceretrive2> createState() => _Insuranceretrive2State();
}

class _Insuranceretrive2State extends State<Insuranceretrive2> {
            ...
            return pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                      'Insurance Amount: ${data['Insurance Amount'] ?? ''}'),
                  pw.Divider(),
                ],
              ),
            );
