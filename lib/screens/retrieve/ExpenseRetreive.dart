...
import 'package:e_commerce/screens/update/expenseupdate.dart';
...
class Expenseretreieve2 extends StatefulWidget {
  const Expenseretreieve2({super.key});

  @override
  State<Expenseretreieve2> createState() => _Expenseretreieve2State();
}

class _Expenseretreieve2State extends State<Expenseretreieve2> {
