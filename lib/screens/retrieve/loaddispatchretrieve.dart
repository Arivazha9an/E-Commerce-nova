...
class Loaddispatchretrieve extends StatefulWidget {
  const Loaddispatchretrieve({super.key});

  @override
  State<Loaddispatchretrieve> createState() => _LoadretrieveState();
}

class _LoadretrieveState extends State<Loaddispatchretrieve> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Load Dispatch', isGoBack: true),
      body: Column(
        children: [
          Padding(
