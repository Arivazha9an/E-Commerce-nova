...
import 'package:e_commerce/screens/update/serviceupdate.dart';
...
class Serviceretrieve2 extends StatefulWidget {
  const Serviceretrieve2({super.key});

  @override
  State<Serviceretrieve2> createState() => _Serviceretrieve2State();
}

class _Serviceretrieve2State extends State<Serviceretrieve2> {
