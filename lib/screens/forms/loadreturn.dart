...
class Loadreturn extends StatefulWidget {
  const Loadreturn({super.key});

  @override
  State<Loadreturn> createState() => _LoadDetailsState();
}

class _LoadDetailsState extends State<Loadreturn> {
  ...
  Widget build(BuildContext context) {
    void _saveData() async {
      if (_dropController.text.isEmpty ||
        ...
        try {
          await FirebaseFirestore.instance.collection('taurusreturn').add({
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Load Return'),
