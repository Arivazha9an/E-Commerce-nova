...
class BDriverpaymentretreive2 extends StatelessWidget {
  const BDriverpaymentretreive2({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream:
          FirebaseFirestore.instance.collection('driverpayment2').snapshots(),
