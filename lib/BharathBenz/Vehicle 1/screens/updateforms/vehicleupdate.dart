...
class _UpdateFormState extends State<UpdateFormVehicle> {
  ...
  void initState() {
    ...
    _vehiclecondition =TextEditingController(text: widget.data['Vehicle Condition'] ?? '');
    _regnocontroller = TextEditingController(text: widget.data['vehicle Number']);
    ...
    _buildyearcontroller = TextEditingController(text: widget.data['Build Year'] ?? '');
  }
