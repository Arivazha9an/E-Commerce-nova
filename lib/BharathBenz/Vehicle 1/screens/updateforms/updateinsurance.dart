...
class UpdateFormInsurance extends StatefulWidget {
  ...
  const UpdateFormInsurance({super.key, required this.docId, required this.data});
...
class _UpdateFormState extends State<UpdateFormInsurance> {
  ...
  void initState() {
    ...
    _policytypecontroller = TextEditingController(text: widget.data['Policy Type'] ?? '');
    _policynocontroller = TextEditingController(text: widget.data['Policy Number'] ?? '');
    _issuecontroller = TextEditingController(text: widget.data['Issue'] ?? '');
    _expirecontroller = TextEditingController(text: widget.data['Expire'] ?? '');
     _insuranceamountcontroller = TextEditingController(text: widget.data['Insurance Amount'] ?? '');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Update Insurance Data', isGoBack: true),
