...
class BAddSupplierdetails extends StatefulWidget {
  const BAddSupplierdetails({super.key});

  @override
  State<BAddSupplierdetails> createState() => _AddsupplierdetailsState();
}

class _AddsupplierdetailsState extends State<BAddSupplierdetails> {
  @override
